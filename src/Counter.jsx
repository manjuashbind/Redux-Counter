      ...
      <Container>
        <Row className='px-2 ' >
          <Col className='col-12 col-sm-12 col-md-10 col-lg-6 col-xl-6 col-xxl-6 text-center mx-auto bg-info-subtle py-5 mt-5 rounded'>
            ...
            <button className='btn btn-success me-2 mt-2' onClick={() => dispatch(increment())}>Increment</button>
            <button className='btn btn-danger me-2 mt-2 ' onClick={() => dispatch(decrement())}>Decrement</button>
            <button className='btn btn-primary me-2 mt-2' onClick={() => dispatch(reset())}>Reset</button>
          </Col>
        </Row>
      </Container>
